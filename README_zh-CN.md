...
<a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/logo.png" alt="项目 Logo"></a>
...
在 Evolink 上体验：[GPT-Image-2](https://evolink.ai/models/gpt-image-2?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts)
...
- [人像与摄影案例](#人像与摄影案例)
  ...
  - [Case 6: Low-Angle POV Fashion Editorial (by @BubbleBrain)](#case-6-low-angle-pov-fashion-editorial-by-bubblebrain)
...
- [海报与插画案例](#海报与插画案例)
  ...
  - [Case 6: Creative Calligraphy Typography (by @liyue_ai)](#case-6-creative-calligraphy-typography-by-liyue_ai)
...
- [角色设计案例](#角色设计案例)
  ...
  - [Case 4: Chibi Character Reference Sheet (by @tsubaki_ew)](#case-4-chibi-character-reference-sheet-by-tsubaki_ew)
  - [Case 5: Official Character Sheet (JP) (by @Toshi_nyaruo_AI)](#case-5-official-character-sheet-jp-by-toshi_nyaruo_ai)
  - [Case 6: Four-Model Realistic Character Sheet Battle (by @yyu_hase)](#case-6-four-model-realistic-character-sheet-battle-by-yyu_hase)
- [UI 与社交媒体截图案例](#ui-与社交媒体截图案例)
  ...
  - [Case 6: Four-Prompt Creative Screenshot Set (by @rionaifantasy)](#case-6-four-prompt-creative-screenshot-set-by-rionaifantasy)
...
- [模型对比与社区案例](#模型对比与社区案例)
  ...
  - [Case 3: Reference Frame Scene Direction (by @HuliJason)](#case-3-reference-frame-scene-direction-by-hulijason)
  - [Case 4: GPT-Image-2 Launch Showcase (by @MikelEcheve)](#case-4-gpt-image-2-launch-showcase-by-mikelecheve)
  - [Case 5: Wooden Bookshelf Prompt Test (by @chetaslua)](#case-5-wooden-bookshelf-prompt-test-by-chetaslua)
  - [Case 6: Trump & Biden Oval Office Handshake (by @signedbywill)](#case-6-trump-biden-oval-office-handshake-by-signedbywill)
  - [Case 7: GPT Image 2 vs Nano Banana 2 Showcase (by @zerolu_eth)](#case-7-gpt-image-2-vs-nano-banana-2-showcase-by-zerolu_eth)
  - [Case 8: Arena First-Impression Test (by @Cheney_NehcOal)](#case-8-arena-first-impression-test-by-cheney_nehcoal)
  - [Case 9: Prompt Swap Bald Photo Test (by @cnzoecomeback)](#case-9-prompt-swap-bald-photo-test-by-cnzoecomeback)
  - [Case 10: GPT-Image-2 Detail Showcase (by @liyue_ai)](#case-10-gpt-image-2-detail-showcase-by-liyue_ai)
  - [Case 11: GPT vs Banana Blind Comparison (by @linxiaobei888)](#case-11-gpt-vs-banana-blind-comparison-by-linxiaobei888)
  - [Case 12: GPT-Image-2 vs Nano Banana 2 Layout Test (by @old_pgmrs_will)](#case-12-gpt-image-2-vs-nano-banana-2-layout-test-by-old_pgmrs_will)
  - [Case 13: Iterative Prompt Tuning Tips (by @kotsu_kotsu_san)](#case-13-iterative-prompt-tuning-tips-by-kotsu_kotsu_san)
  - [Case 14: Copilot Prompt Share (JP/EN) (by @samayousakadaru)](#case-14-copilot-prompt-share-jpen-by-samayousakadaru)
  - [Case 15: Image Generation Agent via Claude Code (by @old_pgmrs_will)](#case-15-image-generation-agent-via-claude-code-by-old_pgmrs_will)
  - [Case 16: A/B Test Signed Output (by @saskr_13)](#case-16-ab-test-signed-output-by-saskr_13)
  - [Case 17: duct-tape-1 Text Rendering Showcase (by @kawai_design)](#case-17-duct-tape-1-text-rendering-showcase-by-kawai_design)
  - [Case 18: Character Setting Material Organizer (by @otohitoyuuki)](#case-18-character-setting-material-organizer-by-otohitoyuuki)
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case1/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case2/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case3/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case4/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case5/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 6: Low-Angle POV Fashion Editorial (by @BubbleBrain) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case6/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case7/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case8/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case1/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case2/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case3/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case4/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case5/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 6: Creative Calligraphy Typography (by @liyue_ai) -->
### Case 6: [Creative Calligraphy Typography](https://x.com/liyue_ai/status/2045328856937312549) (by [@liyue_ai](https://x.com/liyue_ai))

| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case6/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case7/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case8/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case9/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case1/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case2/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case3/output.jpg" width="300" alt="输出图像"> |
...
キャッチコピー:"「ここにセリフ」"
```
<!-- Case 4: Chibi Character Reference Sheet (by @tsubaki_ew) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case4/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case5/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 6: Four-Model Realistic Character Sheet Battle (by @yyu_hase) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case6/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case1/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case2/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case3/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case4/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case5/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 6: Four-Prompt Creative Screenshot Set (by @rionaifantasy) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case6/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case7/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case8/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case1/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case2/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 3: Reference Frame Scene Direction (by @HuliJason) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case3/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 4: GPT-Image-2 Launch Showcase (by @MikelEcheve) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case4/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case5/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 6: Trump & Biden Oval Office Handshake (by @signedbywill) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case6/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 7: GPT Image 2 vs Nano Banana 2 Showcase (by @zerolu_eth) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case7/output.jpg" width="300" alt="输出图像"> |
...
Link in the comment👇
```
<!-- Case 8: Arena First-Impression Test (by @Cheney_NehcOal) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case8/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 9: Prompt Swap Bald Photo Test (by @cnzoecomeback) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case9/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case10/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case11/output.jpg" width="300" alt="输出图像"> |
...
评论区揭晓答案
```
<!-- Case 12: GPT-Image-2 vs Nano Banana 2 Layout Test (by @old_pgmrs_will) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case12/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 13: Iterative Prompt Tuning Tips (by @kotsu_kotsu_san) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case13/output.jpg" width="300" alt="输出图像"> |
...
#AIart #GPT
```
<!-- Case 14: Copilot Prompt Share (JP/EN) (by @samayousakadaru) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case14/output.jpg" width="300" alt="输出图像"> |
...
```
<!-- Case 15: Image Generation Agent via Claude Code (by @old_pgmrs_will) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case15/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case16/output.jpg" width="300" alt="输出图像"> |
...
大事なところに線をひいておきました🤣
```
<!-- Case 17: duct-tape-1 Text Rendering Showcase (by @kawai_design) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case17/output.jpg" width="300" alt="输出图像"> |
...
たくさん実験したくてウズウズします。
```
<!-- Case 18: Character Setting Material Organizer (by @otohitoyuuki) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case18/output.jpg" width="300" alt="输出图像"> |
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case19/output.jpg" width="300" alt="输出图像"> |
...
個人的好みは GPT-Image-2
```
<!-- Case 20: Whiteboard Drawing Showcase (by @jrpj2010) -->
### Case 20: [Whiteboard Drawing Showcase](https://x.com/jrpj2010/status/2044817134761767306) (by [@jrpj2010](https://x.com/jrpj2010))

| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case20/output.jpg" width="300" alt="输出图像"> |
...
→
```
<!-- Case 21: SeeDance 2.0 + GPT-Image-2 Combo (by @CEs7J0Mfn8x37k5) -->
...
| 输出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case21/output.jpg" width="300" alt="输出图像"> |
