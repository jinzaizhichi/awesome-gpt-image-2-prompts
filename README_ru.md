...
<a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/logo.png" alt="Логотип проекта"></a>
...
**Мы собираем качественные промпты и примеры изображений для GPT-Image-2: портреты, постеры, листы персонажей, UI-мокапы и эксперименты сообщества.**

Большинство кейсов в этом репозитории собрано из X/Twitter, сообществ авторов, публичных демо и открыто опубликованных экспериментов.

Попробовать в Evolink: [GPT-Image-2](https://evolink.ai/models/gpt-image-2?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts)

Если репозиторий полезен, поставьте звезду. ⭐

> [!NOTE]
> Этот репозиторий посвящен переиспользуемым шаблонам промптов, референсным кейсам и примерам под конкретные задачи для GPT-Image-2 в Evolink.
...
- **18 апреля 2026:** первый релиз репозитория с отобранной подборкой кейсов GPT-Image-2
...
- [Кейсы портретов и фотографии](#кейсы-портретов-и-фотографии)
  - [Кейс 1: Неоновый портрет у круглосуточного магазина (by @BubbleBrain)](#case-1-convenience-store-neon-portrait-by-bubblebrain)
  - [Кейс 2: Минималистичный кинематографичный портрет (by @iam_miharbi)](#case-2-cinematic-minimal-portrait-by-iam_miharbi)
  - [Кейс 3: Портрет в японском онсэн-рёкане (by @BubbleBrain)](#case-3-japanese-onsen-ryokan-portrait-by-bubblebrain)
  - [Кейс 4: Редакционный портрет с флэшом на 35 мм (by @BubbleBrain)](#case-4-35mm-flash-editorial-portrait-by-bubblebrain)
  - [Кейс 5: Зеркальное селфи-портрет в спальне (by @Shinning1010)](#case-5-mirror-selfie-bedroom-portrait-by-shinning1010)
  - [Кейс 6: Модная editorial-съемка с низкой POV-точкой (by @BubbleBrain)](#case-6-low-angle-pov-fashion-editorial-by-bubblebrain)
  - [Кейс 7: Роскошный glam-бьюти портрет (by @patrickassale)](#case-7-luxury-glam-beauty-portrait-by-patrickassale)
  - [Кейс 8: Скриншот портрета косплеера 9:16 (by @Zoulinshen)](#case-8-916-cosplayer-portrait-screenshot-by-zoulinshen)
- [Кейсы постеров и иллюстраций](#кейсы-постеров-и-иллюстраций)
  - [Кейс 1: Городской постер Бостона, весна 2026 (by @BubbleBrain)](#case-1-boston-spring-2026-city-poster-by-bubblebrain)
  - [Кейс 2: Винтажный туристический постер Амальфи (by @WolfRiccardo)](#case-2-vintage-amalfi-travel-poster-by-wolfriccardo)
  - [Кейс 3: Иллюстрация гастрономической карты Чэнду (by @Panda20230902)](#case-3-chengdu-food-map-illustration-by-panda20230902)
  - [Кейс 4: Китайский минималистичный постер в форме S (by @liyue_ai)](#case-4-chinese-minimalist-s-shaped-poster-by-liyue_ai)
  - [Кейс 5: Городской постер Гуанчжоу, весна 2026 (by @liyue_ai)](#case-5-2026-spring-guangzhou-city-poster-by-liyue_ai)
  - [Кейс 6: Креативная каллиграфическая типографика (by @liyue_ai)](#case-6-creative-calligraphy-typography-by-liyue_ai)
  - [Кейс 7: AI Builder в стиле doodle-скетча (by @blanplan)](#case-7-doodle-sketch-ai-builder-by-blanplan)
  - [Кейс 8: Футуристическая иллюстрация-мандала (by @4WEB1)](#case-8-futuristic-mandala-illustration-by-4web1)
  - [Кейс 9: Постер в стиле Super Famicom (by @lilimliliychan)](#case-9-super-famicom-poster-style-by-lilimliliychan)
- [Кейсы дизайна персонажей](#кейсы-дизайна-персонажей)
  ...
  - [Кейс 6: Сравнение реалистичных листов персонажа между четырьмя моделями (by @yyu_hase)](#case-6-four-model-realistic-character-sheet-battle-by-yyu_hase)
- [Кейсы UI и мокапов для соцсетей](#кейсы-ui-и-мокапов-для-соцсетей)
  ...
  - [Кейс 2: Любительское фото keynote iPhone (by @patrickassale)](#case-2-amateur-iphone-keynote-snapshot-by-patrickassale)
  - [Кейс 3: Фото тетради с рукописными заметками (by @patrickassale)](#case-3-handwritten-notebook-photo-by-patrickassale)
  - [Кейс 4: Лента соцсети в эпоху династии Сун (by @Panda20230902)](#case-4-song-dynasty-social-media-feed-by-panda20230902)
  - [Кейс 5: Скриншоты контента для нескольких платформ (by @MrLarus)](#case-5-multi-platform-content-screenshots-by-mrlarus)
  - [Кейс 6: Креативный набор скриншотов из четырех промптов (by @rionaifantasy)](#case-6-four-prompt-creative-screenshot-set-by-rionaifantasy)
  - [Кейс 7: Скриншот стрима Liu Yifei в Douyin (by @alanblogsooo)](#case-7-liu-yifei-douyin-livestream-screenshot-by-alanblogsooo)
...
- [Сравнения и кейсы сообщества](#сравнения-и-кейсы-сообщества)
  ...
  - [Кейс 6: Рукопожатие Трампа и Байдена в Овальном кабинете (by @signedbywill)](#case-6-trump-biden-oval-office-handshake-by-signedbywill)
...
<!-- Кейс 1: Неоновый портрет у круглосуточного магазина (by @BubbleBrain) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case1/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 2: Минималистичный кинематографичный портрет (by @iam_miharbi) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case2/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 3: Портрет в японском онсэн-рёкане (by @BubbleBrain) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case3/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 4: Редакционный портрет с флэшом на 35 мм (by @BubbleBrain) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case4/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 5: Зеркальное селфи-портрет в спальне (by @Shinning1010) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case5/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 6: Модная editorial-съемка с низкой POV-точкой (by @BubbleBrain) -->
### Case 6: [Low-Angle POV Fashion Editorial](https://x.com/BubbleBrain/status/2044705257004093537) (by [@BubbleBrain](https://x.com/BubbleBrain))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case6/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 7: Роскошный glam-бьюти портрет (by @patrickassale) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case7/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/portrait_case8/output.jpg" width="300" alt="Результат"> |
...
<!-- Кейс 1: Городской постер Бостона, весна 2026 (by @BubbleBrain) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case1/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 2: Винтажный туристический постер Амальфи (by @WolfRiccardo) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case2/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case3/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 4: Китайский минималистичный постер в форме S (by @liyue_ai) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case4/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 5: Городской постер Гуанчжоу, весна 2026 (by @liyue_ai) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case5/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 6: Креативная каллиграфическая типографика (by @liyue_ai) -->
### Case 6: [Creative Calligraphy Typography](https://x.com/liyue_ai/status/2045328856937312549) (by [@liyue_ai](https://x.com/liyue_ai))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case6/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 7: AI Builder в стиле doodle-скетча (by @blanplan) -->
### Case 7: [Doodle Sketch AI Builder](https://x.com/blanplan/status/2045190582453350748) (by [@blanplan](https://x.com/blanplan))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case7/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 8: Футуристическая иллюстрация-мандала (by @4WEB1) -->
### Case 8: [Futuristic Mandala Illustration](https://x.com/4WEB1/status/2045390207072256179) (by [@4WEB1](https://x.com/4WEB1))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case8/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/poster_case9/output.jpg" width="300" alt="Результат"> |
...
<!-- Кейс 1: Преобразование снимка в аниме-кадр (by @Thereallo1026) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case1/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 2: Референс-карта персонажа Persona5 (by @iamrednightS) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case2/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case3/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case4/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case5/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 6: Сравнение реалистичных листов персонажа между четырьмя моделями (by @yyu_hase) -->
### Case 6: [Four-Model Realistic Character Sheet Battle](https://x.com/yyu_hase/status/2044974930694226075) (by [@yyu_hase](https://x.com/yyu_hase))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/character_case6/output.jpg" width="300" alt="Результат"> |
...
<!-- Кейс 1: Генерация UI-дизайна одним промптом (by @austinit) -->
### Case 1: [One-Prompt UI Design Generation](https://x.com/austinit/status/2044968740782272596) (by [@austinit](https://x.com/austinit))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case1/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case2/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 3: Фото тетради с рукописными заметками (by @patrickassale) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case3/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 4: Лента соцсети в эпоху династии Сун (by @Panda20230902) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case4/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 5: Скриншоты контента для нескольких платформ (by @MrLarus) -->
### Case 5: [Multi-Platform Content Screenshots](https://x.com/MrLarus/status/2045373105041007013) (by [@MrLarus](https://x.com/MrLarus))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case5/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 6: Креативный набор скриншотов из четырех промптов (by @rionaifantasy) -->
### Case 6: [Four-Prompt Creative Screenshot Set](https://x.com/rionaifantasy/status/2045356799751303194) (by [@rionaifantasy](https://x.com/rionaifantasy))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case6/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 7: Скриншот стрима Liu Yifei в Douyin (by @alanblogsooo) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case7/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 8: Страница X короля Тхэджо Ли Сонге (by @SKA_Neotype) -->
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/ui_case8/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case1/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case2/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case3/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case4/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case5/output.jpg" width="300" alt="Результат"> |
...
```
<!-- Кейс 6: Рукопожатие Трампа и Байдена в Овальном кабинете (by @signedbywill) -->
### Case 6: [Trump & Biden Oval Office Handshake](https://x.com/signedbywill/status/2045013141629845844) (by [@signedbywill](https://x.com/signedbywill))

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case6/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case7/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case8/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case9/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case10/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case11/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case12/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case13/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case14/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case15/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case16/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case17/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case18/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case19/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case20/output.jpg" width="300" alt="Результат"> |
...
| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-1-5?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts"><img src="./images/comparison_case21/output.jpg" width="300" alt="Результат"> |
...
Этот репозиторий был вдохновлен выдающимися открытыми коллекциями промптов и экспериментами с GPT-Image-2, которыми делилось сообщество.

Спасибо авторам и участникам, которые публично делились своими работами и сделали возможным появление этих кейсов.
...
*Мы не можем гарантировать, что каждый кейс атрибутирован исходному автору. Если что-то нужно исправить, свяжитесь с нами, и мы обновим информацию.*

Если у вас есть еще интересные кейсы с промптами для GPT-Image-2, напишите нам и помогите расширить библиотеку промптов Evolink.
